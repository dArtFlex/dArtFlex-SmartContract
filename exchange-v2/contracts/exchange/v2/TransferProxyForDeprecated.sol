...
contract TransferProxyForDeprecated is Initializable, OperatorRole, ReentrancyGuardUpgradeable, ITransferProxy {
    ...
    function transfer(LibAsset.Asset memory asset, address from, address to) override external nonReentrant onlyOperator {
